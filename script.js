...
console.log('%c👋 Welcome to our website!', 'color: #6366f1; font-size: 20px; font-weight: bold;');
console.log('%cThis is a professional UK-based e-commerce business.', 'color: #94a3b8; font-size: 14px;');
